            ...
            <main className="w-full flex self-center place-content-center py-20">
                <div className="w-2/3 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-gray-800 text-xl font-semibold sm:text-2xl">New Event</h3>
                        </div>
                    </div>
                    <form action={FormHandler} className="justify-center">
                        <div className='flex justify-left'>
                            <div className="py-5 flex flex-col">
                                <label className="text-sm text-gray-600 font-bold"> Event Name </label>
                                <input name="event_name" type="event_name" autoComplete='Default Name' required className="w-72 mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"/>
                            </div>
                        ...
                        <div className="py-3">
                            <label className="text-sm text-gray-600 font-bold"> Attendees (Comma Seperated) </label>
                            <input name="attendees" type="attendees" autoComplete='No Attendees' required className="w-full h-20 mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"/>
                        </div>
                        <div className='flex justify-left'>
                            <div className="py-3">
                                <label className="text-sm text-gray-600 font-bold"> Meeting URL </label>
                                <input name="description" type="description" autoComplete='No Description' required className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"/>
                            </div>
                            <div className="py-3 px-5">
                                <label className="text-sm text-gray-600 font-bold"> Notes Document URL </label>
                                <input name="description" type="description" autoComplete='No Description' required className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"/>
                            </div>
                            <div className="py-3 px-5">
                        ...
                        <div className='justify-center flex flex-row gap-x-5 py-5'>
                            <button type="submit" className={`width-40 px-4 py-2 text-white font-medium rounded-lg bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300 padding`}> Create Event </button>
